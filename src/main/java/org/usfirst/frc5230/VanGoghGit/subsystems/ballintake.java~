...
public class ballintake extends Subsystem {
    ...
    private WPI_TalonSRX ballintakeTalon1;
    private WPI_TalonSRX ballintakeTalon2;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public ballintake() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ballintakeTalon1 = new WPI_TalonSRX(2);
        
        
        
        ballintakeTalon2 = new WPI_TalonSRX(3);
    ...
    public void setIntake(double speed) {
        ballintakeTalon1.set(speed);
        ballintakeTalon2.set(speed);
    }
