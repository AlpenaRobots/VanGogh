...
public class drive extends Subsystem {
 ...
 //   public boolean isDriverControl = true;
    ...
    public void periodic() {
        ...
        rightEncoder = sparkMAX1.getEncoder();
        leftEncoder = sparkMAX3.getEncoder();
    ...
    public boolean toggleDriverControl() {
        if(isDriverControlMode != true) {
            return isDriverControlMode = true;
         } else {
             return isDriverControlMode = false;
         } 
    }
