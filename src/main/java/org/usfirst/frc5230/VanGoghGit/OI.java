...
public class OI {
    ...
    public OI() {
        ...
        lBump2.whileHeld(new ballRotateUp());
        b2 = new JoystickButton(xbox2, 2);
        b2.whileHeld(new ballRotateDown());
        start2 = new JoystickButton(xbox2, 8);
        start2.whenPressed(new ballToggleRotate());
        ...
        back.whenPressed(new returnDriverControl());
        rBump = new JoystickButton(xbox1, 6);
        rBump.whenPressed(new alignWithLimelight());
        ...
        b.whenPressed(new toggleJoystickDrive());
