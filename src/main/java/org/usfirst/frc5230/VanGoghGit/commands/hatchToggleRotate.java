 ...
 *
 */
public class hatchToggleRotate extends Command {
    ...
    protected boolean isFinished() {
        if (Robot.hatchrotate.startingHatchPos != Robot.hatchrotate.hatchPos) {
            return true;
        } else {
            return false;
        }
    ...
    @Override
    protected void end() {
        Robot.hatchrotate.setHatchRotate(0);
    }
